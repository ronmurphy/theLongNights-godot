...
func _ready():
	...
	if _network_mode == NETWORK_MODE_HOST or _network_mode == NETWORK_MODE_SINGLEPLAYER:
		...
		# NOTE: Do NOT auto-swap companions here - respect the saved active_companion_index
		# The CompanionManager.load_roster_from_dict() already restored the correct active companion
