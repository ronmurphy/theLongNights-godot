...
# Constants
const MINUTES_PER_IN_GAME_HOUR = 3.0  # 3 real minutes = 1 in-game hour
const HOURS_PER_DAY = 24
const DAYS_PER_WEEK = 7
const BLOODMOON_START_HOUR = 22  # 10 PM
const BLOODMOON_END_HOUR = 2     # 2 AM
...
func _process(delta: float) -> void:
	...
	if elapsed_time >= MINUTES_PER_IN_GAME_HOUR * 60.0:
		advance_hour()
		elapsed_time = 0.0
